                ...
                <div class="card-body">
                 <div class="table-responsive">
                   <table class="table table-bordered">
                     ...
                     ?>
           s          <tr><td><?php echo $row["contact_name"];?></td><td><?php echo $row["contact_no"];?></td><td><a id="check_num<?php echo $row["contact_id"];?>" class="btn-circle btn-sm btn-success text-center"><i id="check_num_icon<?php echo $row["contact_id"];?>" class="fa fa-check"></i></a></td></tr>
                              <?php  
                                  }
                                }
                            ?>
