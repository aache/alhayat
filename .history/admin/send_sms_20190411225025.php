                 ...
                 <div class="table-responsive">
                   <table class="table table-bordered">
                     ...
                     ?>
                              ...
                              <td><a onclick="toggleContact(<?php echo $row['contact_id']; ?>,'<?php echo $row['contact_name']; ?>')" id="check_num<?php echo $row["contact_id"];?>" class="btn-circle btn-sm btn-success text-center">
  ...
  <script type="text/javascript">
      ...
      function toggleContact(id,number){
        if(numbers.indexOf(number)==-1){
          ...
          $("#check_num_icon"+ id ).addClass("fa-cross");
        }else{
          numbers = numbers.arrayRemove(numbers,number); 
          $("#check_num"+ id ).
          $("#check_num_icon"+ id ).
          $("#check_num"+ id ).
          $("#check_num_icon"+ id ).
